...
test_app_change "dev/demo-app/deployment.yaml" "Update Dev Demo App only"
test_app_change "dev/api-service/service.yaml" "Update Dev API Service only" 
test_app_change "production/demo-app/deployment.yaml" "Update Production Demo App only"
test_app_change "production/api-service/deployment.yaml" "Update Production API Service only"
...
echo "   Files: staging/demo-app/*, production/demo-app/*"
...
echo "   Files: dev/demo-app/*, dev/api-service/*"
echo "   Applications that will sync:"
echo "   ✅ dev-demo-app"
...
echo "   Other environments: staging/*, production/* remain untouched ❌"
